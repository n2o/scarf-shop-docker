 ...
 * ----------------------------------------------------
 *
 * $Id: masterpayment_phone.php 04.06.2012 21:06 $
 *	
 *	The Modul based on:
...
require_once(DIR_FS_CATALOG . 'includes/external/masterpayment/MasterpaymentActions.class.php');
  ...
  class masterpayment_phone extends MasterpaymentActions {
    ...
    function __construct() {
      ...
      $this->sort_order 	= MODULE_PAYMENT_MASTERPAYMENT_PHONE_SORT_ORDER;
      $this->enabled 		= ((MODULE_PAYMENT_MASTERPAYMENT_PHONE_STATUS == 'True') ? true : false);
